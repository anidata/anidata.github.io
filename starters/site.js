...
var getOpenIssues = function (callback) {
    var easy = $.ajax({
        dataType: 'json',
        url: issuesUrl,
        data: "q=type:issue+user:anidata+state:open+label:E:easy+-label:\"C-has%20open%20PR\"&sort=updated"
    })

    var lessEasy = $.ajax({
        dataType: 'json',
        url: issuesUrl,
        data: "q=type:issue+user:anidata+state:open+label:E:less-easy+-label:\"C-has%20open%20PR\"&sort=updated"
    })
